...
- **`text_entities`** (**List of `tgram.types.MessageEntity`**): **Optional. A JSON-serialized list of special entities that appear in the poll option text. It can be specified instead of text_parse_mode**
