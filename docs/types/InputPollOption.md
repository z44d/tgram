...
- **`media`** (**List of [InputPollOptionMedia](InputPollOptionMedia.md) or [InputMediaLink](InputMediaLink.md)** ): **Optional. A JSON-serialized list of media to add to the poll option**
