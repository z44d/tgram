...
- **`options`** (**List of `tgram.types.PollOption`**): **List of poll options**
...
- **`question_entities`** (**List of `tgram.types.MessageEntity`**): **Optional. Special entities that appear in the question. Currently, only custom emoji entities are allowed in poll questions**
...
- **`explanation_entities`** (**List of `tgram.types.MessageEntity`**): **Optional. Special entities like usernames, URLs, bot commands, etc. that appear in the explanation**
