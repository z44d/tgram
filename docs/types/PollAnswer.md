...
their vote.**
- **`option_persistent_ids`** (**List of `str`** ): **Optional. Persistent identifiers of the answer options, chosen by the user. May be empty if the user retracted their vote.**
