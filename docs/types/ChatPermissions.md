...
- **`can_react_to_messages`** (**`bool`** ): **Optional. True, if the user is allowed to react to messages**
- **`can_edit_tag`** (**`bool`** ): **Optional. True, if the user is allowed to edit their profile tag**
