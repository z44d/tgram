...
- **`guest_message`** (**[Message](Message.md)** ): **Optional. New guest message. The bot can use the field Message.guest_query_id and the method
...
- **`managed_bot`** (**[ManagedBotUpdated](ManagedBotUpdated.md)** ): **Optional. A managed bot was created or its token changed.**
- **`subscription`** (**[BotSubscriptionUpdated](BotSubscriptionUpdated.md)** ): **Optional. A user subscribed to the bot or cancelled their subscription**
