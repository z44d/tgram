...
- **`poll_option_id`** (**`str`** ): **Optional. Identifier of the specific poll option to be replied to.**
- **`ephemeral_message_id`** (**`int`** ): **Optional. Identifier of the ephemeral message to be replied to.**
