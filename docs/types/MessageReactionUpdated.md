...
- **`old_reaction`** (**List of `tgram.types.ReactionType`**): **Previous list of reaction types that were set by the user**
- **`new_reaction`** (**List of `tgram.types.ReactionType`**): **New list of reaction types that have been set by the user**
