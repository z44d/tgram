...
- **`guard_bot`** (**[User](User.md)** ): **Optional. The bot that guards the chat**
...
- **`community`** (**[Community](Community.md)** ): **Optional. Information about the community the chat belongs to, if any**
