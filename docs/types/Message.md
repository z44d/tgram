...
- **`guest_query_id`** (**`str`** ): **Optional. The unique identifier for the guest query. Use this identifier with the method
...
- **`guest_bot_caller_user`** (**[User](User.md)** ): **Optional. For a message sent by a guest bot, this is the user whose original message
triggered the bot's response**
- **`guest_bot_caller_chat`** (**[Chat](Chat.md)** ): **Optional. For a message sent by a guest bot, this is the chat whose original message
triggered the bot's response**
...
- **`sender_tag`** (**`str`** ): **Optional. If the sender of the message sent it on behalf of a chat, the tag of the sender**
...
- **`managed_bot_created`** (**[ManagedBotCreated](ManagedBotCreated.md)** ): **Optional. Service message: a managed bot was created**
- **`poll_option_added`** (**[PollOptionAdded](PollOptionAdded.md)** ): **Optional. Service message: a poll option was added**
- **`poll_option_deleted`** (**[PollOptionDeleted](PollOptionDeleted.md)** ): **Optional. Service message: a poll option was deleted**
- **`reply_to_poll_option_id`** (**`str`** ): **Optional. Identifier of the specific poll option that is being replied to**
- **`rich_message`** (**[RichMessage](RichMessage.md)** ): **Optional. Rich message**
- **`receiver_user`** (**[User](User.md)** ): **Optional. The user that received the message**
- **`ephemeral_message_id`** (**`int`** ): **Optional. Unique identifier of the ephemeral message**
- **`community_chat_added`** (**[CommunityChatAdded](CommunityChatAdded.md)** ): **Optional. Service message: a chat was added to a community**
- **`community_chat_removed`** (**[CommunityChatRemoved](CommunityChatRemoved.md)** ): **Optional. Service message: a chat was removed from a community**
