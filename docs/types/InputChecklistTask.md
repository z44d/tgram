...
- **`text_entities`** (**List of `tgram.types.MessageEntity`**): **Optional. List of special entities that appear in the text, which can be specified instead of parse_mode.
