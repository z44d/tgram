...
- **`reaction`** (**List of [ReactionTypeCustomEmoji](../types/ReactionTypeCustomEmoji.md)**) (`optional`): **New list of reaction types to set on the message. Currently, as non-premium users, bots can set up to one reaction per message.
