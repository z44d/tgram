...
- **`media`** (**List of [InputMediaAnimation](../types/InputMediaAnimation.md) or [InputMediaAudio](../types/InputMediaAudio.md) or [InputMediaDocument](../types/InputMediaDocument.md) or [InputMediaLivePhoto](../types/InputMediaLivePhoto.md) or [InputMediaPhoto](../types/InputMediaPhoto.md) or [InputMediaVideo](../types/InputMediaVideo.md) or [InputMediaVoiceNote](../types/InputMediaVoiceNote.md)** ): **A JSON-serialized array describing messages to be sent, must include 2-10 items**
