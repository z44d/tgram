...
- **`format`** (**`str`**)
- **`thumbnail`** (**`Path, bytes, str`**) (`optional`): **A .WEBP or .PNG image with the thumbnail, must be up to 128 kilobytes in size and have a width and height of exactly 100px, or a .TGS animation
