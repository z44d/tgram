...
- **`media`** (**List of [InputPaidMediaLivePhoto](../types/InputPaidMediaLivePhoto.md) or [InputPaidMediaPhoto](../types/InputPaidMediaPhoto.md) or [InputPaidMediaVideo](../types/InputPaidMediaVideo.md)** ): **A JSON-serialized array describing the media to be sent; up to 10 items**
