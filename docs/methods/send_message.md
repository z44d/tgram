...
- **`receiver_user_id`** (**`int`** ) (`optional`): **Optional. Unique identifier of the user that will receive the message**
- **`callback_query_id`** (**`str`** ) (`optional`): **Optional. Identifier of the callback query to reply to**
...
await bot.send_message(
    ...
    receiver_user_id=your_receiver_user_id_here,
