...
class RichTextReference(Type_):
    """
    This object represents a reference rich text.
    ...
    :rtype: :class:`tgram.types.RichTextReference`
    """
    ...
    ) -> Optional["tgram.types.RichTextReference"]:
        return (
            RichTextReference(
                me=me,
                json=d,
