...
class RichBlockMathematicalExpression(Type_):
    """
    This object represents a mathematical expression rich block.
    ...
    :rtype: :class:`tgram.types.RichBlockMathematicalExpression`
    """
    ...
    ) -> Optional["tgram.types.RichBlockMathematicalExpression"]:
        return (
